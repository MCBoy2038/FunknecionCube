...
class ClientPrefs {
	...
	public static var missText:Bool = false;
	public static var accText:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.scoreText = missText;
		FlxG.save.data.scoreText = accText;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.missText != null) {
			missText = FlxG.save.data.missText;
		}
		if(FlxG.save.data.accText != null) {
			accText = FlxG.save.data.accText;
		}
